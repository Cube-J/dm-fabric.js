...
const Pattern = util.createClass(/** @lends fabric.Pattern.prototype */ {
...
Pattern.fromObject = function(object) {
  var patternOptions = Object.assign({}, object);
  return util.loadImage(object.source, { crossOrigin: object.crossOrigin })
    .then(function(img) {
      patternOptions.source = img;
      return new Pattern(patternOptions);
    });
};
