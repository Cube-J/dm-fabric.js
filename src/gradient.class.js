 ...
 */
const Gradient = util.createClass(/** @lends fabric.Gradient.prototype */ {
  ...
  toSVG: function(object, options) {
    ...
    commonAttributes += ' gradientTransform="' + (withViewport ?
      options.additionalTransform + ' ' : '') + util.matrixToSVG(transform) + '" ';
   ...
   */
  toLive: function(ctx) {
    var gradient, coords = util.object.clone(this.coords), i, len;
