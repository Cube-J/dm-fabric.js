...
Control.prototype = /** @lends fabric.Control.prototype */ {
  ...
  calcCornerCoords: function(objectAngle, objectCornerSize, centerX, centerY, isTouch) {
    ...
    if (xSize && ySize && xSize !== ySize) {
      ...
      var newTheta = controlTriangleAngle - util.degreesToRadians(objectAngle);
      var newThetaComp = Math.PI / 2 - controlTriangleAngle - util.degreesToRadians(objectAngle);
      ...
      var newTheta = util.degreesToRadians(45 - objectAngle);
