...
const Image = util.createClass(fabricObject, /** @lends Image.prototype */ {
  ...
  removeTexture: function(key) {
    var backend = window.filterBackend;
...
Image.fromObject = function(_object) {
  ...
  return Promise.all([
    ...
    .then(function(imgAndFilters) {
      ...
      return new Image(imgAndFilters[0], Object.assign(object, imgAndFilters[3]));
    });
};
...
Image.fromElement = function(element, callback, options) {
  ...
  Image.fromURL(parsedAttributes['xlink:href'], Object.assign({ }, options || { }, parsedAttributes))
