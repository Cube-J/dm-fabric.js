 ...
 * @see {@link Line#initialize} for constructor definition
 */
const Line = util.createClass(fabricObject, /** @lends Line.prototype */ {
 ...
 */
Line.ATTRIBUTE_NAMES = SHARED_ATTRIBUTES.concat('x1 y1 x2 y2'.split(' '));
...
Line.fromObject = function(object) {
  ...
  return fabricObject._fromObject(Line, options, 'points').then(function(fabricLine) {
