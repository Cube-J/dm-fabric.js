...
import { IText } from './itext.class.js';
 ...
 */
const Textbox = util.createClass(IText, Observable, {
   ...
   * @private
   */
  _dimensionAffectingProps: Text.prototype._dimensionAffectingProps.concat('width'),
...
Textbox.fromObject = function(object) {
  return fabricObject._fromObject(Textbox, object, 'text');
};
