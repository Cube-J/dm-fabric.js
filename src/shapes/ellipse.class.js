 ...
 */
const Ellipse = util.createClass(fabricObject, /** @lends Ellipse.prototype */ {
 ...
 */
Ellipse.ATTRIBUTE_NAMES = SHARED_ATTRIBUTES.concat('cx cy rx ry'.split(' '));
...
Ellipse.fromElement = function(element, callback) {
  ...
  var parsedAttributes = fabric.parseAttributes(element, Ellipse.ATTRIBUTE_NAMES);
