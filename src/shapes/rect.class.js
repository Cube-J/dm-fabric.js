 ...
 */
const Rect = util.createClass(fabricObject, /** @lends Rectprototype */ {
...
/* _FROM_SVG_START_ */
/**
 * List of attribute names to account for when parsing SVG element (used by `RectfromElement`)
 * @static
 * @memberOf Rect
 * @see: http://www.w3.org/TR/SVG/shapes.html#RectElement
 */
RectATTRIBUTE_NAMES = SHARED_ATTRIBUTES.concat('x y rx ry width height'.split(' '));
 ...
 * @param {Object} [options] Options object
 */
RectfromElement = function(element, callback, options) {
  if (!element) {
    return callback(null);
  }
  options = options || { };

  var parsedAttributes = fabric.parseAttributes(element, RectATTRIBUTE_NAMES);
  parsedAttributes.left = parsedAttributes.left || 0;
  parsedAttributes.top  = parsedAttributes.top  || 0;
  parsedAttributes.height  = parsedAttributes.height || 0;
  parsedAttributes.width  = parsedAttributes.width || 0;
  var rect = new Rect(extend((options ? util.object.clone(options) : { }), parsedAttributes));
 ...
 */
RectfromObject = function(object) {
