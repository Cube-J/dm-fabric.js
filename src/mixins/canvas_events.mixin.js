...
var addListener = util.addListener,
    removeListener = util.removeListener,
...
util.object.extend(Canvas.prototype, /** @lends Canvas.prototype */ {
  ...
  _onTouchStart: function(e) {
    ...
    var canvasElement = this.upperCanvasEl,
        eventTypePrefix = this._getEventPrefix();
    addListener(document, 'touchend', this._onTouchEnd, addEventOptions);
    addListener(document, 'touchmove', this._onMouseMove, addEventOptions);
  ...
  _transformObject: function(e) {
    var pointer = this.getPointer(e),
        ...
        localPointer = target.group ?
          util.sendPointToPlane(pointer, null, target.group.calcTransformMatrix()) :
          pointer;
