...
import { reNonWord } from "../header.js";
...
util.object.extend(IText.prototype, /** @lends IText.prototype */ {
  ...
  initRemovedHandler: function() {
    ...
    this.on('removed', function (opt) {
      ...
      if (canvas) {
        canvas._iTextInstances = canvas._iTextInstances || [];
        util.removeFromArray(canvas._iTextInstances, _this);
  ...
  _calcTextareaPosition: function() {
    ...
    p = util.transformPoint(p, m);
    p = util.transformPoint(p, this.canvas.viewportTransform);
    p.x *= scaleX;
    p.y *= scaleY;
    if (p.x < 0) {
      p.x = 0;
