...
util.object.extend(fabricObject.prototype, /** @lends fabricObject.prototype */ {
  ...
  translateToCenterPoint: function(point, originX, originY) {
    ...
    if (this.angle) {
      return util.rotatePoint(p, point, degreesToRadians(this.angle));
    }
    return p;
  },
  ...
  translateToOriginPoint: function(center, originX, originY) {
    ...
    if (this.angle) {
      return util.rotatePoint(p, center, degreesToRadians(this.angle));
    }
    return p;
  },
  ...
  getCenterPoint: function() {
    ...
    return this.group ?
      util.transformPoint(relCenter, this.group.calcTransformMatrix()) :
      relCenter;
  },
  ...
  normalizePoint: function(point, originX, originY) {
    ...
    if (this.angle) {
      p2 = util.rotatePoint(p2, center, -degreesToRadians(this.angle));
    }
  ...
  //   return util.rotatePoint(point, this.getCenterPoint(), degreesToRadians(this.angle)).addEquals(new Point(this.left, this.top));
  // },
  ...
  adjustPosition: function(to) {
    var angle = degreesToRadians(this.angle),
        ...
        xFull = util.cos(angle) * hypotFull,
        yFull = util.sin(angle) * hypotFull,
        offsetFrom, offsetTo;
