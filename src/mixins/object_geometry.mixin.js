...
util.object.extend(fabricObject.prototype, /** @lends fabricObject.prototype */ {
  ...
  getXY: function () {
    ...
    return this.group ?
      util.transformPoint(relativePosition, this.group.calcTransformMatrix()) :
      relativePosition;
  },
  ...
  setXY: function (point, originX, originY) {
    if (this.group) {
      point = util.transformPoint(
        point,
        util.invertTransform(this.group.calcTransformMatrix())
      );
    }
  ...
  calcOCoords: function () {
    var vpt = this.getViewportTransform(),
        ...
        transformOptions = this.group ? util.qrDecompose(this.calcTransformMatrix()) : undefined,
