...
const StaticCanvas = util.createClass(fabric.CommonMethods, fabric.Collection, /** @lends StaticCanvas.prototype */ {
  ...
  _createLowerCanvas: function (canvasEl) {
    ...
    if (canvasEl && canvasEl.getContext) {
      ...
      this.lowerCanvasEl = util.getById(canvasEl) || this._createCanvasElement();
    }
  ...
  requestRenderAll: function () {
    if (!this.isRendering) {
      this.isRendering = util.requestAnimFrame(this.renderAndResetBound);
    }
    return this;
  },
  ...
  cancelRequestedRender: function() {
    if (this.isRendering) {
      util.cancelAnimFrame(this.isRendering);
      this.isRendering = 0;
    }
  },
  ...
  renderCanvas: function(ctx, objects) {
    ...
    util.setImageSmoothing(ctx, this.imageSmoothingEnabled);
  ...
  _toObjectMethod: function (methodName, propertiesToInclude) {
    ...
    util.populateWithProperties(this, data, propertiesToInclude);
    ...
    var _this = this,
        markup = ['background', 'overlay'].map(function(prop) {
          ...
          if (fill && fill.toLive) {
            ...
            return fill.toSVG(
              object,
              { additionalTransform: shouldTransform ? util.matrixToSVG(vpt) : '' }
            );
          }
        });
    return markup.join('');
  ...
  _setSVGBgOverlayColor: function(markup, property) {
    ...
    if (filler.toLive) {
      var repeat = filler.repeat, iVpt = util.invertTransform(vpt), shouldInvert = this[property + 'Vpt'],
          additionalTransform = shouldInvert ? util.matrixToSVG(iVpt) : '';
      markup.push(
  ...
  dispose: function () {
    ...
    util.cleanUpJsdomNode(this.lowerCanvasEl);
